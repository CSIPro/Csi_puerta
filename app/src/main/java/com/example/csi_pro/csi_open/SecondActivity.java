...
public class SecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final String contraseña = "contraseña";//cambiar contraseña para que sea util
                ...
                if (pass.getText().toString().equals(contraseña)) {
                    ...
                    new AsyncTask<Integer, Void, Void>(){
                        ...
                        protected Void doInBackground(Integer... params) {
                            ...
                            try {
                                executeRemoteCommand("USER-HERE", "PASSWORD-HERE","IP-HERE", PORT-HERE); // cambiar IP y pass para que sea util
                            } catch (Exception e) {
                                e.printStackTrace();
                            }
                            return null;
